...
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.CRUD.Buku.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tahunTerbit" class="form-control-label">Tahun Terbit</label>
                                <input type="date" class="form-control @error('tahunTerbit') is-invalid @enderror" id="tahunTerbit" name="tahunTerbit" value="{{ old('tahunTerbit') }}">
                                @error('tahunTerbit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('jumlah_halaman') is-invalid @enderror" id="jumlah_halaman" name="jumlah_halaman" value="{{ old('jumlah_halaman') }}">
